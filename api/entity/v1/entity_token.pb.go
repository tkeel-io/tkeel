...
var file_api_entity_v1_entity_token_proto_depIdxs = []int32{
	...
	1, // 1: api.entity.v1.EntityToken.CreateEntityToken:input_type -> api.entity.v1.CreateEntityTokenRequest
	3, // 2: api.entity.v1.EntityToken.TokenInfo:input_type -> api.entity.v1.TokenInfoRequest
	3, // 3: api.entity.v1.EntityToken.DeleteEntityToken:input_type -> api.entity.v1.TokenInfoRequest
	2, // 4: api.entity.v1.EntityToken.CreateEntityToken:output_type -> api.entity.v1.CreateEntityTokenResponse
	4, // 5: api.entity.v1.EntityToken.TokenInfo:output_type -> api.entity.v1.TokenInfoResponse
	5, // 6: api.entity.v1.EntityToken.DeleteEntityToken:output_type -> google.protobuf.Empty
