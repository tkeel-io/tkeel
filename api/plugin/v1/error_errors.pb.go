...
func init() {
	...
	pluginErrPluginNotFound = errors.New(int(codes.NotFound), "io.tkeel.rudder.api.plugin.v1.PLUGIN_ERR_PLUGIN_NOT_FOUND", "找不到")
	errors.Register(pluginErrPluginNotFound)
	pluginErrPluginRouteNotFound = errors.New(int(codes.NotFound), "io.tkeel.rudder.api.plugin.v1.PLUGIN_ERR_PLUGIN_ROUTE_NOT_FOUND", "找不到")
	errors.Register(pluginErrPluginRouteNotFound)
	pluginErrPluginAlreadyExists = errors.New(int(codes.AlreadyExists), "io.tkeel.rudder.api.plugin.v1.PLUGIN_ERR_PLUGIN_ALREADY_EXISTS", "找不到")
	errors.Register(pluginErrPluginAlreadyExists)
	pluginErrListPlugin = errors.New(int(codes.Internal), "io.tkeel.rudder.api.plugin.v1.PLUGIN_ERR_LIST_PLUGIN", "获取")
	...
	pluginErrInternalQueryPluginOpenapi = errors.New(int(codes.Internal), "io.tkeel.rudder.api.plugin.v1.PLUGIN_ERR_INTERNAL_QUERY_PLUGIN_OPENAPI", "请求")
	...
	pluginErrOpenapiEnabletenant = errors.New(int(codes.InvalidArgument), "io.tkeel.rudder.api.plugin.v1.PLUGIN_ERR_OPENAPI_ENABLETENANT", "租户启用访问")
	...
	pluginErrOpenapiDisableTenant = errors.New(int(codes.InvalidArgument), "io.tkeel.rudder.api.plugin.v1.PLUGIN_ERR_OPENAPI_DISABLE_TENANT", "租户停用访问")
