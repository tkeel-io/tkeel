...
var file_api_plugin_v1_plugin_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x52, 0x08, 0x75, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x22, 0x8a, 0x03, 0x0a,
	...
	0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xdb, 0x02, 0x0a, 0x0d, 0x45, 0x6e,
	...
	0x79, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x57, 0x6f, 0x72, 0x64, 0x73, 0x22, 0x88, 0x02, 0x0a, 0x12,
...
var file_api_plugin_v1_plugin_proto_goTypes = []interface{}{
	...
	(*TenantEnableRequest_EnableExtraData)(nil), // 18: io.tkeel.rudder.api.plugin.v1.TenantEnableRequest.EnableExtraData
	(v1.PluginStatus)(0),                        // 19: openapi.v1.PluginStatus
	(*v1.AddonsPoint)(nil),                      // 20: openapi.v1.AddonsPoint
	(*v1.ImplementedPlugin)(nil),                // 21: openapi.v1.ImplementedPlugin
...
var file_api_plugin_v1_plugin_proto_depIdxs = []int32{
	...
	2,  // 1: io.tkeel.rudder.api.plugin.v1.PluginBrief.installer_brief:type_name -> io.tkeel.rudder.api.plugin.v1.Installer
	19, // 2: io.tkeel.rudder.api.plugin.v1.PluginBrief.status:type_name -> openapi.v1.PluginStatus
	4,  // 3: io.tkeel.rudder.api.plugin.v1.PluginObject.plugin:type_name -> io.tkeel.rudder.api.plugin.v1.PluginBrief
	20, // 4: io.tkeel.rudder.api.plugin.v1.PluginObject.addons_point:type_name -> openapi.v1.AddonsPoint
	21, // 5: io.tkeel.rudder.api.plugin.v1.PluginObject.implemented_plugin:type_name -> openapi.v1.ImplementedPlugin
	3,  // 6: io.tkeel.rudder.api.plugin.v1.PluginObject.enable_tenantes:type_name -> io.tkeel.rudder.api.plugin.v1.EnabledTenant
	1,  // 7: io.tkeel.rudder.api.plugin.v1.PluginObject.register_addons:type_name -> io.tkeel.rudder.api.plugin.v1.RegisterAddons
	22, // 8: io.tkeel.rudder.api.plugin.v1.PluginObject.console_entries:type_name -> openapi.v1.ConsoleEntry
	2,  // 9: io.tkeel.rudder.api.plugin.v1.InstallPluginRequest.installer:type_name -> io.tkeel.rudder.api.plugin.v1.Installer
	5,  // 10: io.tkeel.rudder.api.plugin.v1.InstallPluginResponse.plugin:type_name -> io.tkeel.rudder.api.plugin.v1.PluginObject
	5,  // 11: io.tkeel.rudder.api.plugin.v1.UninstallPluginResponse.plugin:type_name -> io.tkeel.rudder.api.plugin.v1.PluginObject
	5,  // 12: io.tkeel.rudder.api.plugin.v1.GetPluginResponse.plugin:type_name -> io.tkeel.rudder.api.plugin.v1.PluginObject
	4,  // 13: io.tkeel.rudder.api.plugin.v1.ListPluginResponse.plugin_list:type_name -> io.tkeel.rudder.api.plugin.v1.PluginBrief
	18, // 14: io.tkeel.rudder.api.plugin.v1.TenantEnableRequest.extra:type_name -> io.tkeel.rudder.api.plugin.v1.TenantEnableRequest.EnableExtraData
	3,  // 15: io.tkeel.rudder.api.plugin.v1.ListEnabledTenantsResponse.tenants:type_name -> io.tkeel.rudder.api.plugin.v1.EnabledTenant
	6,  // 16: io.tkeel.rudder.api.plugin.v1.Plugin.InstallPlugin:input_type -> io.tkeel.rudder.api.plugin.v1.InstallPluginRequest
	8,  // 17: io.tkeel.rudder.api.plugin.v1.Plugin.UninstallPlugin:input_type -> io.tkeel.rudder.api.plugin.v1.UninstallPluginRequest
	10, // 18: io.tkeel.rudder.api.plugin.v1.Plugin.GetPlugin:input_type -> io.tkeel.rudder.api.plugin.v1.GetPluginRequest
	12, // 19: io.tkeel.rudder.api.plugin.v1.Plugin.ListPlugin:input_type -> io.tkeel.rudder.api.plugin.v1.ListPluginRequest
	14, // 20: io.tkeel.rudder.api.plugin.v1.Plugin.TenantEnable:input_type -> io.tkeel.rudder.api.plugin.v1.TenantEnableRequest
	15, // 21: io.tkeel.rudder.api.plugin.v1.Plugin.TenantDisable:input_type -> io.tkeel.rudder.api.plugin.v1.TenantDisableRequest
	16, // 22: io.tkeel.rudder.api.plugin.v1.Plugin.ListEnabledTenants:input_type -> io.tkeel.rudder.api.plugin.v1.ListEnabledTenantsRequest
	7,  // 23: io.tkeel.rudder.api.plugin.v1.Plugin.InstallPlugin:output_type -> io.tkeel.rudder.api.plugin.v1.InstallPluginResponse
	9,  // 24: io.tkeel.rudder.api.plugin.v1.Plugin.UninstallPlugin:output_type -> io.tkeel.rudder.api.plugin.v1.UninstallPluginResponse
	11, // 25: io.tkeel.rudder.api.plugin.v1.Plugin.GetPlugin:output_type -> io.tkeel.rudder.api.plugin.v1.GetPluginResponse
	13, // 26: io.tkeel.rudder.api.plugin.v1.Plugin.ListPlugin:output_type -> io.tkeel.rudder.api.plugin.v1.ListPluginResponse
	23, // 27: io.tkeel.rudder.api.plugin.v1.Plugin.TenantEnable:output_type -> google.protobuf.Empty
	23, // 28: io.tkeel.rudder.api.plugin.v1.Plugin.TenantDisable:output_type -> google.protobuf.Empty
	17, // 29: io.tkeel.rudder.api.plugin.v1.Plugin.ListEnabledTenants:output_type -> io.tkeel.rudder.api.plugin.v1.ListEnabledTenantsResponse
