...
func init() {
	...
	errStoreCreatAdmin = errors.New(int(codes.Internal), "tenant.v1.ERR_STORE_CREAT_ADMIN", Error_ERR_STORE_CREAT_ADMIN.String())
	errors.Register(errStoreCreatAdmin)
	errStoreCreatAdminRole = errors.New(int(codes.Internal), "tenant.v1.ERR_STORE_CREAT_ADMIN_ROLE", Error_ERR_STORE_CREAT_ADMIN_ROLE.String())
