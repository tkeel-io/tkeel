        ...
        stage('build & push') {
            environment {
                ...
                */
                ...
                chart 文件夹相对路径
                */
                CHART_PATH = 'charts/rudder'
                DOCKERFILES_PATH = 'docker/rudder/Dockerfile'
                    ...
                    withCredentials([kubeconfigFile(credentialsId: env.KUBECONFIG_CREDENTIAL_ID,variable: 'KUBECONFIG')]) {
                        script {                        
                            if (env.TKEEL_PLUGIN_ENABLE_UPGRADE == 'yes'){
                                ...
                                sh 'tkeel upgrade --repo-url=https://$REGISTRY/chartrepo/$REPOSITORY --repo-name=$REPOSITORY  --rudder-version=$CHART'
                            }else{
